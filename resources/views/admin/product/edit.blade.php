    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-block">
                <form class="form-material" method="POST" action="{{ route('admin.product.update', $product->id) }}" enctype="multipart/form-data">
                @csrf 
                @method('PUT')
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group form-default ">
                                <select name="category_name" class="form-control @error('category_name') is-invalid @enderror" id="category_name">
                                    ...
                                    <option value="{{ $c->id }}" {{ ($product->category_id == $c->id) ? 'selected=selected' : '' }}>{{ $c->category_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-default ">
                                <select name="parent_sub_category" class="form-control @error('parent_sub_category') is-invalid @enderror" id="parent_sub_category">
                                    @foreach($parentSubCategory as $p)
                                    <option value="{{ $p->id }}" {{ ($product->parent_sub_category == $p->id) ? 'selected=selected' : '' }}>{{ $p->sub_category }}</option>
                                    @endforeach
                                </select>
                                <span class="form-bar"></span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-default ">
                                <select name="sub_category" class="form-control @error('sub_category') is-invalid @enderror" id="sub_category">
                                    ...
                                    <option value="{{ $sc->id }}" {{ ($sc->id == $product->sub_category) ? 'selected=selected' : '' }}>{{ $sc->sub_category }}</option>
                                    @endforeach  
                                </select>
                                <span class="form-bar"></span>
                        ...
                        <div id="childSubCategory" class="col-md-6">
                            <div class="form-group form-default ">
                                <select name="child_sub_category" class="form-control @error('child_sub_category') is-invalid @enderror" id="child_sub_category">
                                    ...
                                    <option value="{{ $cs->id }}" @if($cs->id == $product->child_sub_category) Selected @endif>{{ $cs->sub_category }}</option>
                                    @endforeach
                                </select>
                                <span class="form-bar"></span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-default">
                                <select name="brand_name" class="form-control @error('brand_name') is-invalid @enderror" id="brand_name">
                                    ...
                                    <option value="{{ $bn->id }}" {{ ($bn->id == $product->brand_name) ? 'selected=selected' : '' }}>{{ $bn->brand_name }}</option>
                                    @endforeach
                                </select>
                                <span class="form-bar"></span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-default">
                                <input type="text" name="product_description" class="form-control @error('product_description') is-invalid @enderror" value="{{ $product->product_description }}">
                                <span class="form-bar"></span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-default">
                                <input type="number" name="cost_price" class="form-control @error('cost_price') is-invalid @enderror" value="{{ $product->cost_price }}">
                                <span class="form-bar"></span>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="tags_add">
                                <input type="text" class="form-control" data-role="tagsinput" name="size" value="{{ $product->size }}">
                            </div>
                                @error('size')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="col-md-12">
                            <div class="form-group form-default">
                                ...
                                ?>
                                    ...
                                    <a href="{{  URL::asset('ProductImg/' . $explodeProduct[$i]) }}" target="_blank" class="m-3"> Click to view</a>
                                    @endfor
                                @endif
